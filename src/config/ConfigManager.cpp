//===- MonitorX/src/config/ConfigManager.cpp - Configuration Loader & Saver -*- C++ -*-===//
//
//                     MonitorX — Save File Monitoring Tool
//
// This file implements ConfigManager, a concrete implementation of
// IConfigManager. It handles reading/writing JSON-based settings and
...
ConfigManager::algorithmFromString(const QString &s) {
